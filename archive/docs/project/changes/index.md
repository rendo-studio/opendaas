---
name: Changes
description: VibeCoding 的变化可见入口，聚合当前活跃 change 与最近完成变化。
---
...
1. 完成 `bootstrap-opendaas-self-hosting`
2. 完成 `production-hardening-iteration-1`
3. 固定 `docs/` / `.opendaas/` 边界
4. 固定树形 task 模型
5. 固定 `Fumadocs` 作为站点运行时方向

## 值得关注的变化

当前最值得关注的是：

- 单一 `init` 是否足以成为真正的对外入口
